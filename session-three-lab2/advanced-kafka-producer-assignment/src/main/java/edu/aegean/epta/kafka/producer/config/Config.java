package edu.aegean.epta.kafka.producer.config;

import edu.aegean.epta.kafka.producer.partitioner.CustomPartitioner;
...
public class Config {
    ...
    public NewTopic advancedTopic() {
        return TopicBuilder.name("kafka-advanced-topic").replicas(1).partitions(10).build();
    }
